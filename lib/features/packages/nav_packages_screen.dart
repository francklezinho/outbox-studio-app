// lib/features/packages/nav_packages_screen.dart
...
class NavPackagesScreen extends StatefulWidget {
  final Function(int)? onTabChanged;

  const NavPackagesScreen({super.key, this.onTabChanged});

  @override
  State<NavPackagesScreen> createState() => _NavPackagesScreenState();
}

class _NavPackagesScreenState extends State<NavPackagesScreen>
            ...
            children: [
              Material(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    print('🔧 DEBUG: Clicou na seta de voltar'); // ✅ DEBUG
                    print('🔧 DEBUG: onTabChanged é null? ${widget.onTabChanged == null}'); // ✅ DEBUG

                    // ✅ SOLUÇÃO ROBUSTA: Múltiplas tentativas para voltar para Home
                    if (widget.onTabChanged != null) {
                      print('🔧 DEBUG: Chamando onTabChanged(0)'); // ✅ DEBUG
                      widget.onTabChanged!(0); // Tentar ir para Home via callback
                    } else {
                      print('🔧 DEBUG: onTabChanged é null, tentando DefaultTabController'); // ✅ DEBUG

                      // ✅ FALLBACK 1: Tentar DefaultTabController
                      final tabController = DefaultTabController.of(context);
                      if (tabController != null) {
                        print('🔧 DEBUG: DefaultTabController encontrado, mudando para índice 0'); // ✅ DEBUG
                        tabController.animateTo(0);
                      } else {
                        print('🔧 DEBUG: DefaultTabController não encontrado, tentando pop'); // ✅ DEBUG

                        // ✅ FALLBACK 2: Navigator pop
                        if (Navigator.of(context).canPop()) {
                          Navigator.of(context).pop();
                        } else {
                          print('🔧 DEBUG: Não pode fazer pop, ficando na tela atual'); // ✅ DEBUG
                        }
                      }
                    }
                  },
              ...
              if (_sortBy != 'Default')
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: AppTheme.accentPrimary.withAlpha(76)),
                  ),
                  child: Text(
                    'Sorted by $_sortBy',
                    style: TextStyle(
  ...
  Widget _buildModernPackageCard(PackageData package, int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: package.color.withAlpha(76),
          width: 1.5,
        ),
        boxShadow: [
          BoxShadow(
          ...
          BoxShadow(
            color: package.color.withAlpha(25),
            blurRadius: 20,
            spreadRadius: 2,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      package.color.withAlpha(204),
                      package.color.withAlpha(153),
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
          ...
          if (package.features.length > 2)
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: package.color.withAlpha(204),
                  fontFamily: 'Lato',
                  fontSize: 12,
              ...
              Expanded(
                child: OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(color: package.color.withAlpha(128), width: 1.5),
              ...
              Expanded(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    elevation: 8,
                    shadowColor: package.color.withAlpha(76),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12),
                    ),
                    padding: const EdgeInsets.symmetric(vertical: 10),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            AppTheme.backgroundSecondary,
            AppTheme.backgroundTertiary.withAlpha(204),
          ],
          begin: Alignment.topCenter,
          end: Alignment.bottomCenter,
        ),
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        foregroundColor: Colors.white,
                        elevation: 12,
                        shadowColor: data.color.withAlpha(102),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(16),
                        ),
                      ),
